                ...
                <div class="dev full-width">
                    <button  v-on:click="connect()">connect</button> 
                        <div class="flex full-width flex-row space-between">
                            ...
                            <card id="takesInput" class="dev takes-input margin-right-base" >
                                <details class="user-info full-width takes-input" style="box-shadow: none;">
                                    <summary>
                                    <h6 class="dev text-align-left inline-block margin-none padding-bottom-sm">User Dietary Needs and Preferences</h6>
                                    </summary> 
                            ...
                            <card id="start" class="dev card question-input takes-input margin-left-base" >
