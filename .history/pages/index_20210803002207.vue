<template>
  <div class="dev container diagram">
    <div class="dev column col-left">
      ...
      <card id="questionInput" class="dev card question-input takes-input">
  ...
  <div class="dev col-centerd">
    <div class="dev center section1">
      <details id="expandedUserQuestion" class="dev static-entities">
        <summary>
...
export default {
  ...
  methods: {
    connect: function (){
      new LeaderLine(
    document.getElementById('takeQuestion'),
    document.getElementById('expandedUserQuestion')
    );
    new LeaderLine(
