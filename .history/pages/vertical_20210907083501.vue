            ...
            <div class="dev full-width container diagram" >
                ...
                <div class="dev full-width section">
                    <div class="flex full-width flex-row space-around">
                        <div id="KBQA" class='dev KBQA' style="width: 100%; margin: auto;">
                            <card class="dev static-entities" style="margin: 0;">
                                <h6 class="dev box-title">KBQA</h6>
                            </card>
                        </div>  
                        <div id="foodKG" class="foodKG" style="width: 100%; margin: auto;">
