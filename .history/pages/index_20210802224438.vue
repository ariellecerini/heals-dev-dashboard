  ...
  <div class="dev container diagram">
    <div class="dev column col-left">
      ...
      <card class="dev takes-input">
          ...
          <form>
             <label for="AgeInYears">Age</label>
            <input id="AgeInYears" type="number">
              <span>years</span>
              </input>
                ...
                <input id="WeightInLbs" style="width: 48%" type="number" label="Weight"> 
                  <span>lbs</span>
                  </input>
              <label for="HeightInFt">Weight</label>
                <input id="HeightInFt" style="width: 48%" type="number" label="height"> 
                  <span>ft</span>
                  </input>
          </form>
