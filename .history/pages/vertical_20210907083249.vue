            ...
            <div class="dev full-width container diagram" >
                ...
                <div class="dev full-width section">
                    <div class="flex full-width flex-row space-around">
                        <div id="KBQA" class='dev KBQA' style="width: 100%;">
                            <card class="dev static-entities">
                                <h6 class="dev box-title">KBQA</h6>
                            </card>
                        </div>  
                        <div id="foodKG" class="foodKG" style="width: 100%;">
                            <card class="dev static-entities" style="width: 100%; max-width: 250px; margin-left: 0; margin-right: auto;">
